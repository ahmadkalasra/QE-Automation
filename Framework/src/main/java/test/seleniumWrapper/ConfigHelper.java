...
public class ConfigHelper
{
    ...
    private static final String FILE_PATH = String.join(File.separator,
            TestConstants.PathVariables.GET_BASE_DIRECTORY,
            "src","test","resources",
            TestConstants.PathVariables.CONFIG_FILE_NAME);
